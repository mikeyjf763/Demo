...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/v1/items',
            ...
            ...(fetchMiddlewares<RequestHandler>(ItemsController.prototype.getProducts)),

            function ItemsController_getProducts(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/v1/items/:id',
            ...(fetchMiddlewares<RequestHandler>(ItemsController)),
            ...(fetchMiddlewares<RequestHandler>(ItemsController.prototype.getProduct)),

            function ItemsController_getProduct(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/v1/items',
            ...(fetchMiddlewares<RequestHandler>(ItemsController)),
            ...(fetchMiddlewares<RequestHandler>(ItemsController.prototype.addProduct)),

            function ItemsController_addProduct(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/v1/orders',
            ...
            function OrdersController_getOrders(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/v1/orders/:orderId',
            ...
            function OrdersController_getOrderById(request: any, response: any, next: any) {
            const args = {
